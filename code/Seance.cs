...
Use the information the dead give you and work with the other innocent Terrorists to find the Traitors.";
        ...
        [ConVar.Server(
            ...
            Help = "Assign one seance per specified player count. For example, setting this to 7 will mean that there will be one seance per 7 players. The default is 7.",
            Saved = true
        )]
